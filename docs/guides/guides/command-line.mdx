...
| `--runner-ui`                  | [Display the command log, application under test url bar, viewport preview, and browser dropdown while recording Test Replay (can negatively impact performance)](#cypress-run-runner-ui)     |
| `--no-runner-ui`               | [Hide the command log, application under test url bar, viewport preview, and browser dropdown while recording Test Replay](#cypress-run-no-runner-ui)                                         |
...
Display the command log, application under test url bar, viewport preview, and browser
dropdown while recording Test Replay (can negatively impact performance)
...
Hide the command log, application under test url bar, viewport preview, and browser
dropdown while recording Test Replay (Test Replay default)
