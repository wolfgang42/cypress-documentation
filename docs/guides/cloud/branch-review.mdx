...
Once the GitHub integration is configured for a project, "Branch Review" is the default view of the **Branches** tab. Otherwise, a list of "Runs" filtered by this branch will default with tips for how to enable and maximize this feature.
